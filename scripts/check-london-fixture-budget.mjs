...
const BUDGETS = {
  raw: 1_600 * 1024,
  gzip: 260 * 1024,
  javaScript: 347 * 1024, // Airport shell, screen-space picking and the shared renderer's budgeted vehicle scheduler (alpha.17); the board has a separate lazy budget.
  css: 14 * 1024,
  total: 650 * 1024,
  layoutRaw: 90 * 1024,
  layoutGzip: 16 * 1024,

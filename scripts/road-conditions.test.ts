...
const manifest: NationalRoadStudyManifest = JSON.parse(readFileSync('public/data/all-change-road-day-manifest.json', 'utf8'))
...
describe('indexed road conditions', () => {
  it('matches recorded conditions and counts through playback, seeks and road selection', () => {
    ...
    for (const time of [...times, ...times.toReversed()]) {
      ...
      for (const road of [undefined, 'M1', 'M25', 'missing']) {

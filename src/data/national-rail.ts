import { positionForTrain, type NetworkPath, type NetworkSnapshot, type NetworkTrain } from '@motionstudies/core/domain/network'
...
export interface NationalRailTrain extends NetworkTrain {
  ...
  readonly source: { readonly table: string; readonly page: number; readonly block: number; readonly column: number }
}
